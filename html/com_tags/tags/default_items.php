...
<form action="<?php echo htmlspecialchars(JUri::getInstance()->toString()); ?>" method="post" name="adminForm" id="adminForm">
				...
				<div class="col-sm-8">
					...
					<div class="btn-group-no input-group">
					    ...
					    <span class="input-group-btn">
							...
							<button type="reset" name="filter-clear-button" title="<?php echo JText::_('JSEARCH_FILTER_CLEAR'); ?>" class="btn btn-primary" onclick="resetFilter(); document.adminForm.submit();">
	...
	<?php else : ?>
		<?php foreach ($this->items as $i => $item) : ?>
			...
			<li class="cat-list-row<?php echo $i % 2; ?> list-group-item clearfix">
			<h5>
