...
<div class="profile-edit<?php echo $this->pageclass_sfx?>">
	...
	<?php endif; ?>
		...
		<div class="control-group form-group">
			<div class="col-sm-9 col-sm-offset-3 controls">
				<button type="submit" class="btn btn-primary validate"><span><?php echo JText::_('JSUBMIT'); ?></span></button>
				<a class="btn btn-primary" href="<?php echo JRoute::_('index.php?option=com_users&view=profile'); ?>" title="<?php echo JText::_('JCANCEL'); ?>"><?php echo JText::_('JCANCEL'); ?></a>
