...
<form action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post" id="login-form" class="form">
	...
	<div class="userdata">
			...
			<div class="controls">
				<?php if (!$params->get('usetext')) : ?>
					<div class="input-prepend">
						...
						<input id="modlgn-username" type="text" name="username" class="form-control input-sm" tabindex="0" size="18" placeholder="<?php echo JText::_('MOD_LOGIN_VALUE_USERNAME') ?>" />
					</div>
				<?php else: ?>
			...
			<div class="controls">
				<?php if (!$params->get('usetext')) : ?>
					<div class="input-prepend">
						...
						<input id="modlgn-passwd" type="password" name="password" class="form-control input-sm" tabindex="0" size="18" placeholder="<?php echo JText::_('JGLOBAL_PASSWORD') ?>" />
					</div>
				<?php else: ?>
		...
		<div id="form-login-secretkey" class="control-group form-group">
			<div class="controls">
				<?php if (!$params->get('usetext')) : ?>
					<div class="input-prepend input-append">
						<span class="add-on">
							<span class="glyphicon glyphicon-star hasTooltip" title="<?php echo JText::_('JGLOBAL_SECRETKEY'); ?>">
							</span>
								<label for="modlgn-secretkey" class="element-invisible"><?php echo JText::_('JGLOBAL_SECRETKEY'); ?>
							</label>
						</span>
						<input id="modlgn-secretkey" autocomplete="off" type="text" name="secretkey" class="form-control input-sm" tabindex="0" size="18" placeholder="<?php echo JText::_('JGLOBAL_SECRETKEY') ?>" />
		...
		<?php
			...
			<?php if ($usersConfig->get('allowUserRegistration')) : ?>
				<li>
					...
					<?php echo JText::_('MOD_LOGIN_REGISTER'); ?> <span class="glyphicon glyphicon-arrow-right"></span></a>
				</li>
			<?php endif; ?>
				<li>
